const translations = {
	...
	en: {
		...
		skills: { title: 'Skill Set', journeyTitle: 'Vision & Learning Journey', journeyDesc: 'Strengthening my technical foundations while adapting to modern software requirements.' },
